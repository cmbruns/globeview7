...
class GeoCanvas(QtOpenGLWidgets.QOpenGLWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.layers.append(basemap.TestRasterTile("Sub-tiles", [(0, 1, 2), (3, 2, 2)]))
    ...
    def initializeGL(self) -> None:
        ...
        GL.glBufferData(GL.GL_UNIFORM_BUFFER, 16 + 6*64, None, GL.GL_DYNAMIC_DRAW)
    ...
    def paint_opengl(self):
        ...
        m4[:3, :3] = vs.ndc_X_win.T
        GL.glBufferSubData(GL.GL_UNIFORM_BUFFER, 336, 64, m4)
